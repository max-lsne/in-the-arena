...
let finds = SEED.map(s => ({ ...s }));
let project = 'The last week of May · a bookbinder\'s bench in a coast town';
...
function resetToSeed() {
  finds = SEED.map(s => ({ ...s }));
  project = 'The last week of May · a bookbinder\'s bench in a coast town';
  activeFilter = 'all';
