...
(function () {
  ...
  // --- keyboard: the floor is worked hands-first ---
  // N steep · J/K walk the floor · ]/[ or Enter turn the condition
  // 0–3 move it across the floor · R or Del take it off to the kiln
